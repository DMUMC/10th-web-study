  ...
  return (
    <nav className="h-16 bg-[#121212] border-b border-gray-800 flex items-center justify-between px-6 sticky top-0 z-50">
      <div className="flex items-center gap-4">
        <button onClick={onMenuClick} className="text-white hover:text-[#FF007A] transition-colors p-2">
          <svg width="24" height="24" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path 
              d={isSidebarOpen ? "M10.5 10.5L37.5 37.5" : "M7.94971 11.9497H39.9497"} 
              stroke="currentColor" 
              strokeWidth="4" 
              strokeLinecap="round" 
            ...
            <path 
              ...
              strokeLinecap="round" 
              strokeLinejoin="round" 
              className={`transition-all duration-300 ${isSidebarOpen ? "opacity-0" : "opacity-100"}`}
            />
            <path 
              d={isSidebarOpen ? "M10.5 37.5L37.5 10.5" : "M7.94971 35.9497H39.9497"} 
              stroke="currentColor" 
              strokeWidth="4" 
              strokeLinecap="round" 
              strokeLinejoin="round" 
