...
function LpDetailPage() {
  ...
  useEffect(() => {
    if (lp?.data && !isEdit) {
      ...
      setPreviewImage(lp.data.thumbnail);
    }
  }, [lp, isEdit]);
      ...
      {lpPending ? (
        ...
        <>
          ...
          <div
            ...
            className="relative w-60 h-60 flex justify-center items-center bg-pink-200 rounded-full mb-6 overflow-hidden cursor-pointer"
          >
            <img
              src={previewImage}
              alt={editTitle}
