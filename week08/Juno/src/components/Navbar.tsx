...
import burgerIconUrl from '../assets/burger.svg'; 
...
export const Navbar = ({ onToggleSidebar }: NavbarProps) => {
  ...
  return (
    <nav className="sticky top-0 z-40 flex items-center justify-between bg-black p-4 text-white shadow-md h-16 border-b border-neutral-800">
