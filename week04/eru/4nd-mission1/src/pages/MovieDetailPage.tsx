...
export default function MovieDetailPage() {
    ...
    const { data: details, isPending: detailPending, isError: detailError } = useCustomFetch<MovieDetails>(detailUrl);
    const { data: credits, isPending: creditsPending, isError: creditsError } = useCustomFetch<Credits>(creditsUrl);

    const isPending = detailPending || creditsPending;
    const isError = detailError || creditsError;
